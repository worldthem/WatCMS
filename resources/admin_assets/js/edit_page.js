...
function return_text(types=''){
  var mainDiv = types ==''? '<a href="#" class="sort_icon fa_move fa_small editable" ></a>' :'';
...
$(function() {
       // Sortable for the divs inside sortable dropable
        ...
        $("#page_contents div div.inside_grid").append(return_text()); 
       ...
       // Add new block 
          $("a.add_grid").click(function(){
              ...
              var content_is = '<div class="'+tip+class_inside+'" id="'+uniqId()+'">'
                                                     + return_text(type_is) +
                                            '</div>';
